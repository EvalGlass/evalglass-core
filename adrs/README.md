...
- 0039 — *retired: metric discovery moved to the [`evalglass-discovery`](https://github.com/EvalGlass/evalglass-discovery) repo.*
- [0040 — Generic OpenAI-compatible judge lane](0040-openai-compatible-judge-lane.md)
- 0041 — *retired: the discovery scaffolder moved to the [`evalglass-discovery`](https://github.com/EvalGlass/evalglass-discovery) repo.*
